var tileLayer=L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'});var map=L.map('map',{layers:[tileLayer]}).setView([37.8,-96],4);var defaultBounds=L.latLngBounds([[24.396308,-125.0],[49.384358,-66.93457]]);var statesToColor=["Alabama","Arizona","Arkansas","Connecticut","Florida","Georgia","Kansas","Kentucky","Louisiana","Maryland","Massachusetts","Mississippi","Montana","Nevada","New Hampshire","New Jersey","New Mexico","New York","North Carolina","North Dakota","Pennsylvania","South Carolina","Tennessee","Texas","Utah","Vermont","Virginia","Washington","West Virginia","Wisconsin","Wyoming"];var geojsonLayer;var currentMarker;function getFillOpacity(zoom){return zoom>=6?0.75:1;}
